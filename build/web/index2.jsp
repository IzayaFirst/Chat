<%-- 
    Document   : index2
    Created on : Oct 3, 2016, 8:41:50 PM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>You're User 2 Name : Kevin</h2>
            <h2>Your Chatmate is User 1 Name : James</h2>
             <a href="index.jsp"><p>see in James chat</p></a>
            <hr>
            <input type="text" id="chat-text" class="form-control" placeholder="Type Here" > <a id="btn" href="#" class="btn btn-primary">Send</a>
            <input type="hidden" id="userId1" value="2">
             <input type="hidden" id="userId2" value="1">
            <br>
            <div class="row">
                <ul class="list-group">
